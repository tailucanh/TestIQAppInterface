...
public class ActivitySecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goiY.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityFirst.suggestions(ActivitySecond.this," \" Quy luật: Trong mỗi hàng, biểu tượng phía dưới gạch ngang không thay đổi. Ngoài ra, khi xét riêng các biểu tượng trên gạch ngang, chúng xuất hiện theo thứ tự: hình vuông và tròn bên trái, hình vuông chính giữa, hình vuông và tròn bên phải. \"");
            }
        });
            ...
            public void onClick(View v) {
                ...
                switch (dapAn_Checked){
                    ...
                    case R.id.rdo_dapanD:
                        ...
                        break;
                    default:
                        Toast.makeText(ActivitySecond.this, "Hãy chọn 1 đáp án !", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
        ...
        dauhang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog = new Dialog(ActivitySecond.this);
    ...
    void anhXa(){
        ...
        groupDapAn = findViewById(R.id.rdg_caudo2);
    ...
    public void submitTrue(){
        final  Dialog dialog = new Dialog(ActivitySecond.this);
        ...
        tieptuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(),ActivityThird.class);
                Toast.makeText(ActivitySecond.this, "Câu số 3...", Toast.LENGTH_LONG).show();
    ...
    public void chrCountDown(){
        if(ActivityFirst.COUNT == 10){
            Toast.makeText(ActivitySecond.this, "10s cuối cùng ! Nhanh tay nào ", Toast.LENGTH_SHORT).show();
        }

        if(ActivityFirst.COUNT == 0){
            ActivityFirst.dialogTimeOut(ActivitySecond.this,chronometerCountDown);
            Toast.makeText(ActivitySecond.this, "Đã hết thời gian! ", Toast.LENGTH_LONG).show();
